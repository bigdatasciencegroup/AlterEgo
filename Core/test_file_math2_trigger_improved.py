...
with tf.Session() as session:
    if test_model:
        ...
        saver.restore(session, 'math2_trigger_model.ckpt')
...
#    data.from_file.start('serial_data/data_2019_02_27_16_47_38.txt',
                      on_data, channels=channels, transform_fn=transform_data,
                      history_size=1500, shown_size=1200, override_step=35, sample_rate=250, speed=1.0)