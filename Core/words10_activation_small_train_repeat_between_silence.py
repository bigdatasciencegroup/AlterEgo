...
labels = [6, 4, 6, 7, 3, 4, 5, 2, 9, 8, 8, 4, 9, 1, 4, 2, 0, 5, 7, 0, 0, 3, 8, 0, 3, 0, 9, 3, 9, 6, 4, 8, 7, 1, 1, 2, 3, 5, 2, 7, 7, 7, 6, 0, 2, 7, 8, 5, 0, 6, 0, 9, 9, 5, 9, 3, 2, 6, 7, 6, 5, 5, 3, 5, 3, 8, 1, 5, 2, 8, 9, 0, 3, 4, 1, 3, 9, 0, 2, 1, 5, 2, 8, 3, 1, 6, 9, 8, 6, 9, 8, 0, 0, 3, 9, 5, 1, 9, 7, 4, 8, 1, 2, 9, 4, 6, 8, 3, 3, 0, 7, 6, 4, 1, 5, 1, 0, 7, 5, 1, 7, 5, 7, 1, 3, 4, 1, 6, 2, 7, 7, 2, 5, 6, 8, 8, 1, 7, 6, 1, 0, 3, 2, 1, 4, 0, 7, 4, 6, 3, 9, 4, 7, 5, 9, 1, 2, 5, 5, 2, 5, 3, 9, 8, 3, 6, 4, 9, 8, 1, 8, 5, 6, 6, 3, 7, 4, 3, 9, 2, 6, 2, 3, 4, 7, 4, 5, 8, 9, 2, 4, 7, 7, 0, 3, 8, 1, 6, 3, 1, 8, 0, 9, 7, 2, 6, 7, 9, 9, 4, 8, 0, 6, 1, 0, 6, 4, 8, 2, 3, 2, 6, 5, 9, 5, 1, 6, 2, 3, 6, 8, 2, 4, 8, 0, 5, 1, 4, 5, 2, 1, 5, 5, 3, 4, 0, 4, 7, 6, 0, 9, 3, 5, 8, 4, 9, 7, 0, 6, 2, 0, 3, 0, 2, 1, 0, 1, 9, 1, 4, 3, 9, 7, 8, 6, 0, 0, 0, 4, 2, 8, 7, 2, 1, 5, 8, 8, 9, 5, 9, 7, 2, 4, 4, 4, 6, 8, 2, 7, 1]

sequence_groups = transform_data([data.flatten(data.process_scrambled(labels, ['words10.txt'], channels=channels, sample_rate=250,
                                                                      surrounding=surrounding, exclude=set([207])))])

#silence_group = transform_data(data.process(1, ['math6_silence.txt'], channels=channels, sample_rate=250, surrounding=surrounding))
silence_group = transform_data(data.process_silence_between(['words10.txt'], channels=channels, sample_rate=250, surrounding=surrounding))
    ...
    with tf.Session() as session:
        ...
        for epoch in range(num_epochs):
            ...
            if validation_accuracy > max_validation_accuracy:
                model_name = 'words10_activation_small_model.ckpt'
        ...
        if good_run:
            ...
            model_name = 'words_activation_small_model.ckpt'
            save_path = saver.save(session, os.path.join(abs_path, model_name))
            print ' Model saved:', model_name,
