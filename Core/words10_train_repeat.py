...
training_sequence_groups = transform_data(data.process_scrambled(labels, ['words10.txt'], channels=channels, sample_rate=250,
    ...
    with tf.Session() as session:
        ...
        for epoch in range(num_epochs):
            ...
            if validation_accuracy > max_validation_accuracy:
                model_name = 'words10_trigger_model.ckpt'
