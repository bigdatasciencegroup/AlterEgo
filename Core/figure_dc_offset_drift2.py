...
sequence_groups = [data.process_file('data/data/214_w10_s1.txt', sample_rate=1000, channels=range(0, 8))[6000:173000]]
...
sequence = sequence_groups[0]
sequence2 = data.transform.subtract_initial(sequence)
...
plt.subplots_adjust(left=0.0625, right=0.98, bottom=0.13, top=0.93)
axes[0].set_title('Signal DC Offset')
axes[0].set_xlabel('Sample')
axes[0].set_ylabel(u'Signal (\u03bcV)')
axes[1].set_title('Signal Baseline Drift')
...
plt.savefig('figure_dc_offset_drift2.png')
plt.show()
