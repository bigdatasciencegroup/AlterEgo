...
training_sequence_groups = transform_data(data.digits_5_3_dataset(channels=channels))
...
validation_sequence_groups = transform_data(data.digits_5_4_dataset(channels=channels))
