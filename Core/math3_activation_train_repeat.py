...
training_sequence_groups = transform_data([data.flatten(data.process_scrambled(labels, ['math3.txt'], channels=channels, sample_rate=250, surrounding=surrounding))])
...
validation_sequence_groups = transform_data([data.flatten(data.process_scrambled(labels, ['math3_test.txt'], channels=channels, sample_rate=250, surrounding=surrounding))])
    ...
    with tf.Session() as session:
        ...
        for epoch in range(num_epochs):
            ...
            if validation_accuracy > max_validation_accuracy:
                model_name = 'math3_activation_model.ckpt'
