...
sequence_groups = transform_data(data.process_scrambled(labels, ['math4.txt'], channels=channels, sample_rate=250, surrounding=surrounding))
    ...
    with tf.Session() as session:
        ...
        for epoch in range(num_epochs):
            ...
            if validation_accuracy > max_validation_accuracy:
                model_name = 'math4_triggerless_model.ckpt'
