...
labels = [9, 6, 9, 10, 5, 6, 8, 3, 13, 12, 13, 7, 14, 2, 6, 3, 0, 8, 11, 1, 1, 5, 12, 0, 5, 0, 14, 4, 14, 9, 6, 12, 11, 2, 2, 4, 4, 8, 4, 10, 11, 11, 9, 0, 3, 11, 12, 8, 0, 10, 0, 14, 14, 8, 14, 5, 3, 9, 10, 9, 7, 7, 5, 8, 5, 12, 1, 8, 4, 12, 14, 0, 5, 6, 2, 5, 14, 0, 4, 1, 8, 3, 12, 5, 1, 9, 14, 12, 9, 13, 12, 0, 0, 4, 14, 8, 2, 14, 11, 6, 12, 2, 3, 14, 6, 9, 13, 5, 4, 0, 11, 9, 6, 1, 8, 2, 1, 11, 8, 2, 11, 7, 10, 1, 4, 7, 1, 10, 3, 11, 11, 3, 7, 9, 12, 12, 2, 10, 10, 2, 1, 5, 3, 2, 6, 1, 11, 6, 10, 5, 14, 7, 11, 7, 13, 2, 3, 8, 8, 4, 8, 5, 13, 12, 5, 10, 7, 14, 13, 2, 13, 8, 9, 9, 4, 10, 6, 4, 13, 4, 9, 3, 4, 7, 11, 7, 7, 13, 14, 4, 6, 11, 11, 0, 4, 12, 2, 10, 5, 1, 13, 1, 13, 10, 3, 10, 10, 13, 14, 7, 13, 0, 9, 2, 0, 10, 6, 13, 3, 5, 3, 9, 7, 13, 8, 2, 9, 3, 4, 9, 12, 4, 7, 12, 0, 8, 1, 6, 8, 4, 2, 8, 7, 5, 6, 1, 6, 11, 9, 0, 14, 5, 7, 13, 6, 14, 11, 1, 9, 3, 0, 5, 1, 3, 2, 0, 2, 14, 1, 6, 5, 13, 10, 13, 10, 0, 1, 0, 7, 4, 12, 10, 3, 2, 7, 12, 12, 13, 8, 14, 11, 3, 6, 7, 6, 10, 12, 3, 11, 1]

sequence_groups = transform_data([data.flatten(data.process_scrambled(labels, ['math10.txt'], channels=channels, sample_rate=250,
...
silence_group = transform_data(data.process_silence_between(['math10.txt'], channels=channels, sample_rate=250, surrounding=surrounding))
...
training_sequence_groups, validation_sequence_groups = data.split(sequence_groups, 1./4)
    ...
    with tf.Session() as session:
        ...
        for epoch in range(num_epochs):
            ...
            if validation_accuracy > max_validation_accuracy:
                model_name = 'math10_activation_small_model.ckpt'
