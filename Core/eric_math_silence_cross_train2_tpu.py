...
def model_computation(inputs, targets, weights, training):
    ...
    return logits, loss, correct, accuracy, optimizer
####################


logits, loss, correct, accuracy = tpu.rewrite(model_computation, model_inputs)
#print tpu.rewrite(model_computation, model_inputs)
