...
training_sequence_groups = transform_data(data.process_scrambled(labels, ['math10.txt'], channels=channels, sample_rate=250,
...
training_sequence_groups, validation_sequence_groups = data.split(training_sequence_groups, 1./4)
...
training_sequence_groups = data.transform.pad_truncate(training_sequence_groups, 600)
    ...
    with tf.Session() as session:
        ...
        for epoch in range(num_epochs):
            ...
            if validation_accuracy > max_validation_accuracy:
                model_name = 'math10_trigger_model.ckpt'
