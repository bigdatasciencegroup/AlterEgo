...
sequence_groups1 = transform_data(data.process_scrambled(labels, ['math6.txt'], channels=channels, sample_rate=250,
...
sequence_groups2 = transform_data(data.process_scrambled(labels, ['math6_test.txt'], channels=channels, sample_rate=250,
