...
channels = range(0, 8) # DO NOT CHANGE
#channels = range(0, 5) # DO NOT CHANGE
surrounding = 250

labels = [12, 8, 12, 14, 7, 8, 11, 4, 18, 16, 17, 9, 19, 3, 8, 5, 0, 11, 14, 1, 1, 7, 16, 0, 7, 1, 19, 6, 19, 12, 9, 16, 15, 3, 3, 5, 6, 10, 5, 14, 14, 15, 12, 0, 4, 14, 16, 10, 1, 13, 0, 18, 19, 11, 19, 7, 4, 12, 14, 12, 10, 10, 6, 10, 7, 16, 2, 11, 5, 16, 18, 1, 7, 8, 2, 7, 19, 0, 5, 2, 11, 4, 17, 7, 2, 12, 19, 16, 13, 18, 16, 1, 0, 6, 19, 11, 2, 18, 15, 8, 17, 2, 5, 18, 9, 12, 17, 7, 6, 0, 15, 12, 8, 2, 11, 3, 1, 15, 11, 3, 15, 10, 14, 2, 6, 9, 2, 13, 4, 14, 15, 4, 10, 12, 16, 17, 3, 14, 13, 2, 1, 6, 4, 3, 9, 1, 15, 8, 13, 7, 19, 9, 15, 10, 18, 3, 4, 11, 11, 5, 11, 7, 18, 16, 7, 13, 9, 19, 17, 3, 17, 11, 12, 12, 6, 14, 8, 6, 18, 5, 12, 4, 6, 9, 14, 9, 10, 17, 19, 5, 8, 15, 15, 0, 6, 16, 3, 13, 6, 2, 17, 1, 18, 14, 5, 13, 14, 18, 19, 9, 17, 0, 13, 3, 0, 13, 8, 17, 5, 7, 4, 12, 10, 18, 10, 3, 12, 4, 6, 13, 17, 5, 9, 16, 0, 10, 2, 9, 11, 5, 3, 11, 10, 6, 8, 1, 8, 15, 13, 0, 19, 6, 10, 17, 9, 19, 15, 1, 13, 4, 1, 7, 1, 5, 2, 0, 3, 19, 2, 8, 7, 18, 14, 17, 13, 0, 1, 0, 9, 5, 16, 14, 4, 3, 10, 16, 16, 18, 11, 18, 15, 4, 8, 9, 8, 13, 17, 4, 15, 2]

sequence_groups = transform_data([data.flatten(data.process_scrambled(labels, ['words20.txt'], channels=channels, sample_rate=250,
...
silence_group = transform_data(data.process_silence_between(['words20.txt'], channels=channels, sample_rate=250, surrounding=surrounding))
    ...
    with tf.Session() as session:
        ...
        for epoch in range(num_epochs):
            ...
            if validation_accuracy > max_validation_accuracy:
                model_name = 'words20_activation_small_model.ckpt'
