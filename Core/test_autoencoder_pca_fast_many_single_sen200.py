...
window_size = 62 #250, 300 1000, 2000
stride = 40 # 250, 125
...
with tf.Session() as session:
    ...
    saver.restore(session, 'autoencoder_single_sen200_' + str(window_size) + '_' + str(latent_size) + '_model.ckpt')
...
#            test_encodings = [np.array(mu) for _ in range(num_shown)]
            ...
            if last_value == 200:
                plt.savefig('figure_autoencoder_single_sen200_principle_components_pos.png')
            if last_value == -200:
                plt.savefig('figure_autoencoder_single_sen200_principle_components_neg.png')
