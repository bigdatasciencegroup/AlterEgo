...
training_sequence_groups = transform_data(data.process_scrambled(labels, ['math2.txt'], channels=channels, sample_rate=250, surrounding=surrounding))

training_silence_group = transform_data(data.process(1, ['math2_silence.txt'], channels=channels, sample_rate=250, surrounding=surrounding))
...
validation_sequence_groups = transform_data(data.process_scrambled(labels, ['math2_test.txt'], channels=channels, sample_rate=250, surrounding=surrounding))

validation_silence_group = transform_data(data.process(1, ['math2_test_silence.txt'], channels=channels, sample_rate=250, surrounding=surrounding))
