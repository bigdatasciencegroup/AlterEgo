...
sequence_groups = transform_data(data.process_scrambled(labels, ['eric1.txt'], channels=channels, sample_rate=250))
sequence_groups2 = transform_data(data.process_scrambled(labels, ['eric2.txt'], channels=channels, sample_rate=250))
sequence_groups = data.combine([sequence_groups, sequence_groups2])
