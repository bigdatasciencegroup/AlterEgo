...
training_sequence_groups = transform_data(
    data.process_scrambled(labels, ['eric3.txt'], channels=channels, sample_rate=250))
...
validation_sequence_groups = transform_data(
    data.process_scrambled(labels, ['eric4.txt'], channels=channels, sample_rate=250))
...
training_sequence_groups = data.transform.augment_amplitude_multipliers(training_sequence_groups, multipliers)
#validation_sequence_groups = data.transform.augment_amplitude_multipliers(validation_sequence_groups, multipliers)
