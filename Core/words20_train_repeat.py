...
training_sequence_groups = transform_data(data.process_scrambled(labels, ['words20.txt'], channels=channels, sample_rate=250,
    ...
    with tf.Session() as session:
        ...
        for epoch in range(num_epochs):
            ...
            if training_accuracy > 0.96:
                good_run = True
            if not good_run and epoch + 1 >= 75: #150
                break
            ...
            if validation_accuracy > max_validation_accuracy:
                model_name = 'words20_trigger_model.ckpt'
