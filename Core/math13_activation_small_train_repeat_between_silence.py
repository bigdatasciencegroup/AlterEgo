...
sequence_groups = transform_data([data.flatten(data.process_scrambled(labels, ['math13.txt'], channels=channels, sample_rate=250,
...
silence_group = transform_data(data.process_silence_between(['math13.txt'], channels=channels, sample_rate=250, surrounding=surrounding))
    ...
    with tf.Session() as session:
        ...
        for epoch in range(num_epochs):
            ...
            if validation_accuracy > max_validation_accuracy:
                model_name = 'math13_activation_small_model.ckpt'
