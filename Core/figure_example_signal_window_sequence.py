...
sequence = sequence_groups[0][1][2200:4700]
...
filename = 'figure_example_signal_window_sequence.png'
...
filename = 'figure_example_signal_window_sequence_window1.png'
plt.savefig(filename, transparent=True)
plt.show()
...
sequence = sequence_groups[0][1][2450:3700]
...
for i in range(len(channels)):
    plt.plot(sequence[:,i], c=colors[channels[i]], alpha=1.0, lw=1.5)
plt.gca().set_ylim(ylim)
filename = 'figure_example_signal_window_sequence_window2.png'
plt.savefig(filename, transparent=True)
plt.show()
...
sequence = sequence_groups[0][1][2700:3950]
...
for i in range(len(channels)):
    plt.plot(sequence[:,i], c=colors[channels[i]], alpha=1.0, lw=1.5)
plt.gca().set_ylim(ylim)
filename = 'figure_example_signal_window_sequence_window3.png'
plt.savefig(filename, transparent=True)
plt.show()
...
sequence = sequence_groups[0][1][2950:4200]
...
for i in range(len(channels)):
    plt.plot(sequence[:,i], c=colors[channels[i]], alpha=1.0, lw=1.5)
plt.gca().set_ylim(ylim)
filename = 'figure_example_signal_window_sequence_window4.png'
plt.savefig(filename, transparent=True)
plt.show()
...
sequence = sequence_groups[0][1][3200:4450]
...
for i in range(len(channels)):
    plt.plot(sequence[:,i], c=colors[channels[i]], alpha=1.0, lw=1.5)
plt.gca().set_ylim(ylim)
filename = 'figure_example_signal_window_sequence_window5.png'
plt.savefig(filename, transparent=True)
plt.show()
...
sequence = sequence_groups[0][1][3450:4700]
...
for i in range(len(channels)):
    plt.plot(sequence[:,i], c=colors[channels[i]], alpha=1.0, lw=1.5)
plt.gca().set_ylim(ylim)
filename = 'figure_example_signal_window_sequence_window6.png'
plt.savefig(filename, transparent=True)
plt.show()
