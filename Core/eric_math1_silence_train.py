...
sequence_groups = transform_data(data.process_scrambled(labels, ['math1.txt'], channels=channels, sample_rate=250))

silence_group = transform_data(data.process(1, ['math1_silence.txt'], channels=channels, sample_rate=250))
