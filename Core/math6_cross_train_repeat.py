...
training_sequence_groups = transform_data(data.process_scrambled(labels, ['math6.txt'], channels=channels, sample_rate=250, surrounding=surrounding,
                                                        exclude=set([25, 99, 407])))
...
validation_sequence_groups = transform_data(data.process_scrambled(labels, ['math6_test.txt'], channels=channels, sample_rate=250, surrounding=surrounding,
                                                        exclude=set([36, 66, 73])))
    ...
    with tf.Session() as session:
        ...
        for epoch in range(num_epochs):
            ...
            if validation_accuracy > max_validation_accuracy:
                model_name = 'math6_trigger_model.ckpt'
