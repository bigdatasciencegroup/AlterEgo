...
training_sequence_groups, validation_sequence_groups = train_test_split(sequence_groups, range(3, 20, 5))
...
words = np.array(['1', '8', '2', '3', '0', '9', '4', '7', '6', '5'])
label_map = [
    [2, 9, 6, 4, 0],
    [9, 5, 3, 0, 8],
    [8, 4, 7, 3, 5],
...
ctc_output = tf.nn.ctc_beam_search_decoder(logits, sequence_lengths, top_paths=5) # 30, 10
