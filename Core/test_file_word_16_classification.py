...
#data.from_file.start('data/data/20_subvocal_the_50_trials.txt', on_data, speed=1.0)
#data.from_file.start('data/data/21_subvocal_a_50_trials.txt', on_data, speed=1.0)
#data.from_file.start('data/data/23_subvocal_is_50_trials.txt', on_data, speed=1.0)
#data.from_file.start('data/data/37_subvocal_information_50_trials.txt', on_data, speed=1.0)
data.from_file.start('data/data/33_subvocal_about_50_trials.txt', on_data, speed=1.0)
