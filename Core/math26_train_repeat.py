...
training_sequence_groups = transform_data(data.process_scrambled(labels, ['math26.txt'], channels=channels, sample_rate=250,
    ...
    with tf.Session() as session:
        ...
        for epoch in range(num_epochs):
            ...
            if validation_accuracy > max_validation_accuracy:
                model_name = 'math26_trigger_model2.ckpt'
...
#            model_name = 'math26_trigger_model.ckpt'
#            save_path = saver.save(session, os.path.join(abs_path, model_name))
#            print ' Model saved:', model_name,
