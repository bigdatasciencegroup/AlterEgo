...
conv1 = tf.layers.conv1d(inputs, 400, 12, activation=tf.nn.relu, padding='valid') # 12
conv1 = tf.layers.max_pooling1d(conv1, 2, strides=2)
conv2 = tf.layers.conv1d(conv1, 400, 6, activation=tf.nn.relu, padding='valid') # 6
conv2 = tf.layers.max_pooling1d(conv2, 2, strides=2)
conv3 = tf.layers.conv1d(conv2, 400, 3, activation=tf.nn.relu, padding='valid') # 3
conv3 = tf.layers.max_pooling1d(conv3, 2, strides=2)
conv4 = tf.layers.conv1d(conv3, 400, 3, activation=tf.nn.relu, padding='valid') # 3
conv4 = tf.layers.max_pooling1d(conv4, 2, strides=2)
conv5 = tf.layers.conv1d(conv4, 400, 3, activation=tf.nn.relu, padding='valid') # 3
...
with tf.Session() as session:
    ...
    saver.restore(session, 'autoencoder_300_model.ckpt')
    ...
    for batch in range(num_training_batches):         
        ...
        batch_output = session.run(outputs, feed)
...
conv1 = tf.layers.max_pooling1d(conv1, 2, strides=2)
conv2 = tf.layers.conv1d(conv1, 400, 12, activation=tf.nn.relu, padding='valid')
conv2 = tf.layers.max_pooling1d(conv2, 2, strides=2)
#conv3 = tf.layers.conv1d(conv1, 400, 12, activation=tf.nn.relu, padding='valid')
#conv3 = tf.layers.max_pooling1d(conv3, 2, strides=2)
