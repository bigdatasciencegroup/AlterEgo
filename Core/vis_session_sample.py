...
test_index = 10 #0
plt.figure(1)
for i in range(len(sequence_groups1[test_index])):
    plt.plot(sequence_groups1[test_index][i])
plt.figure(2)
for i in range(len(sequence_groups2[test_index])):
    plt.plot(sequence_groups2[test_index][i])
plt.show()
